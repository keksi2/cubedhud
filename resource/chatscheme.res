...
Scheme
{
	...
	BaseSettings
	{
		...
		Button.ArmedTextColor			"White^3"
		Button.ArmedBgColor				"Blank"
		Button.DepressedTextColor		"White^3"
		Button.DepressedBgColor			"Blank"
		Button.FocusBorderColor			"Black^3"
		...
		ComboBoxButton.ArrowColor		"Black^3"
		ComboBoxButton.ArmedArrowColor	"White^3"
		ComboBoxButton.BgColor			"Blank"
		ComboBoxButton.DisabledBgColor	"Blank"

		"Chat.TypingText"		"White^3"
		...
		FrameTitleBar.TextColor			"White^3"
		FrameTitleBar.BgColor			"Blank"
		FrameTitleBar.DisabledTextColor	"255 255 255 192"
		FrameTitleBar.DisabledBgColor	"Blank"

		GraphPanel.FgColor				"White^3"
		GraphPanel.BgColor				"TransparentBlack"

		Label.TextDullColor				"Black^3"
		...
		ListPanel.TextColor					"White^3"
		ListPanel.TextBgColor				"Blank"
		ListPanel.BgColor					"TransparentBlack"
		ListPanel.SelectedTextColor			"Black^3"
		ListPanel.SelectedBgColor			"Generic^3"
		ListPanel.SelectedOutOfFocusBgColor	"255 155 0 128"
		ListPanel.EmptyListInfoTextColor	"Black^3"

		Menu.TextColor					"White^3"
		Menu.BgColor					"160 160 160 64"
		Menu.ArmedTextColor				"Black^3"
		Menu.ArmedBgColor				"Generic^3"
		Menu.TextInset					"6"

		Panel.FgColor					"Blank"
		Panel.BgColor					"Black^3"

		ProgressBar.FgColor				"White^3"
		ProgressBar.BgColor				"TransparentBlack"

		PropertySheet.TextColor			"White^3"
		PropertySheet.SelectedTextColor	"White^3"
		PropertySheet.TransitionEffectTime	"0.25"	// time to change from one tab to another

		RadioButton.TextColor			"Black^3"
		RadioButton.SelectedTextColor	"White^3"
		...
		ScrollBarButton.FgColor				"White^3"
		ScrollBarButton.BgColor				"Blank"
		ScrollBarButton.ArmedFgColor		"White^3"
		ScrollBarButton.ArmedBgColor		"Blank"
		ScrollBarButton.DepressedFgColor	"White^3"
		ScrollBarButton.DepressedBgColor	"Blank"

		ScrollBarSlider.FgColor				"TransparentBlack" // nob color
		ScrollBarSlider.BgColor				"Blank"	// slider background color

		SectionedListPanel.HeaderTextColor	"White^3"
		SectionedListPanel.HeaderBgColor	"Blank"
		SectionedListPanel.DividerColor		"Black^3"
		SectionedListPanel.TextColor		"White^3"
		SectionedListPanel.BrightTextColor	"White^3"
		SectionedListPanel.BgColor			"TransparentBlack"
		SectionedListPanel.SelectedTextColor			"Black^3"
		SectionedListPanel.SelectedBgColor				"Generic^3"
		...
		TextEntry.TextColor			"White^3"
		TextEntry.BgColor			"TransparentBlack"
		TextEntry.CursorColor		"Black^3"
		TextEntry.DisabledTextColor	"Black^3"
		TextEntry.DisabledBgColor	"Blank"
		TextEntry.SelectedTextColor	"Black^3"
		TextEntry.SelectedBgColor	"Generic^3"
		TextEntry.OutOfFocusSelectedBgColor	"255 155 0 128"
		TextEntry.FocusEdgeColor	"0 0 0 196"

		ToggleButton.SelectedTextColor	"White^3"

		Tooltip.TextColor			"0 0 0 196"
		Tooltip.BgColor				"Generic^3"
		...
		MainMenu.TextColor			"White^3"				[$WIN32]
		MainMenu.TextColor			"200 200 200 255"	[$X360]
		MainMenu.ArmedTextColor		"200 200 200 255"	[$WIN32]
		MainMenu.ArmedTextColor		"White^3"				[$X360]
		...
		Console.TextColor			"Black^3"
		Console.DevTextColor		"White^3"

		NewGame.TextColor			"White^3"
		NewGame.FillColor			"0 0 0 255"
		NewGame.SelectionColor		"Generic^3"	[$WIN32]
